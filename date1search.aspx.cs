...
public partial class date1search : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                string productindate = Request.QueryString["INDATE"];
                ...
                OleDbCommand cmd = new OleDbCommand("select * from intable where INDATE=productindate", con);

                OleDbParameter parameter = new OleDbParameter("@INDATE", productindate);
