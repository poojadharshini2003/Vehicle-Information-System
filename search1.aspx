...
<body>
    ...
    style="background-position: center bottom; background-image: url('img/bg1.jpg'); z-index: 1; left: 4px; top: -4px; position: absolute; width: 1275px;">
    ...
    <asp:Button ID="Button23" runat="server" BackColor="Transparent" 
        Font-Bold="True" Font-Italic="True" Font-Names="MV Boli" Font-Size="Medium" 
        ForeColor="White" 
        style="z-index: 1; left: 775px; top: 1px; position: absolute; height: 34px; width: 106px; right: 394px;" 
    ...
    <asp:Button ID="Button25" runat="server" BackColor="Transparent" 
        ...
        <div style="background-position: 50% bottom; z-index: 1; left: 5px; top: 35px; position: absolute; height: 1020px; width: 1275px; background-image: url('img/ser.jpg');">
        <asp:Menu 
        ...
        BorderColor="Black" onmenuitemclick="Menu1_MenuItemClick1">
